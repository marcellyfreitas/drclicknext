...
const convenioService = new ConvenioService(httpClient);

export const ConveniosIndex: React.FC = () => {
	...
	const fetchUsers = async () => {
		try {
			const response = await convenioService.getAll();
	...
	return (
		<Container>
			<div className="flex justify-between items-center mb-4">
				<h1 className="font-semibold text-xl">Convênios</h1>
